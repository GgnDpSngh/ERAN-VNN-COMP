...
timeout 300 python3 -u . --netname relu_image_models/colt/mnist_0.3.onnx --dataset mnist --domain refinepoly --epsilon 0.3  --mean 0.1307 --std 0.3081  --timeout_lp 50  --sparse_n 4 > results/colt/mnist_0.3.txt

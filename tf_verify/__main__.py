...
if dataset=='acasxu':
    ...
    for box_index, box in enumerate(boxes):
        ...
        try:
            ...
            if all(res):
                print("AcasXu property", config.specnumber, "UNSAT for Box", box_index, "out of",len(boxes))
            else:
                print("AcasXu property", config.specnumber, "SAT for Box", box_index, "out of",len(boxes))
